<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>名称：</view>
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.name}}</view>
				</view>
