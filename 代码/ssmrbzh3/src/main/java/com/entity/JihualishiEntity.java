...
public class JihualishiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JihualishiEntity() {
		
	}
	
	public JihualishiEntity(T t) {
		try {
	 ...
	 * 设置：计划天数
	 */
	public void setJihuatianshu(Integer jihuatianshu) {
		this.jihuatianshu = jihuatianshu;
	}
	/**
	 * 获取：计划天数
	 */
	public Integer getJihuatianshu() {
		return jihuatianshu;
	}
	/**
	 * 设置：完成度
