 ...
 */
@TableName("jihuadaka")
public class JihuadakaEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JihuadakaEntity() {
		
	}
	
	public JihuadakaEntity(T t) {
		try {
	 ...
	 * 设置：打卡天数
	 */
	public void setDakatianshu(Integer dakatianshu) {
		this.dakatianshu = dakatianshu;
	}
	/**
	 * 获取：打卡天数
	 */
	public Integer getDakatianshu() {
		return dakatianshu;
	}
	/**
	 * 设置：账号
